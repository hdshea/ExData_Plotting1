...
#
#  script for plotting to plot4.png
#
...
par(mfrow=c(2,2)) # 2 x 2 plot display
...
with( pcData,
    {
        ...
        # Global Active Power plot - top left panel
        ...
        # Sub metering plot - bottom left panel
        plot(Sub_metering_1,
        ...
        # Global reactive power plot - bottom right panel
